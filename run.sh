python3 train_stage1.py --cfg ./config/cifar10/cifar10_imb001_stage1_mixup.yaml rho 1. gamma 0.
python3 train_stage1.py --cfg ./config/cifar10/cifar10_imb001_stage1_mixup.yaml rho 0.1 gamma 0.
python3 train_stage1.py --cfg ./config/cifar10/cifar10_imb001_stage1_mixup.yaml rho 0.5 gamma 0.
python3 train_stage1.py --cfg ./config/cifar10/cifar10_imb001_stage1_mixup.yaml rho 10 gamma 0.
